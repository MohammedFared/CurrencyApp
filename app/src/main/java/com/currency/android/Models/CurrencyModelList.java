...
public class CurrencyModelList {
    ...
    private CurrencyModelList.QueryBean query;
    /**
    ...
    public CurrencyModelList.QueryBean getQuery() {
        return query;
    }

    public static class QueryBean{

        private CurrencyModelList.QueryBean.ResultsBean results;

        public CurrencyModelList.QueryBean.ResultsBean getResults() {
            return results;
        }

        public static class ResultsBean{

            private ArrayList<RatesBean> rate;
